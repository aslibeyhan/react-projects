...
function Currency() {
    ...
    let API_KEY = "fca_live_kH4zxdvk9xLtxwIGMKueOqmq4EHWd36MtO96deWq";
    ...
    return (
        <div className="currency-div">
            <div style={{ marginTop: '0px', fontFamily: 'arial', backgroundColor: 'white', color: 'darkblue', width: '100%', textAlign: 'center' }}>
